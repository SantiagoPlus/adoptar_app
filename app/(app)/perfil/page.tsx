...
function MascotasSkeleton() {
  return (
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
      <div className="flex min-h-[160px] animate-pulse rounded-2xl border-2 border-dashed border-white/5 bg-white/5" />
      <div className="flex h-[160px] animate-pulse rounded-2xl bg-white/5" />
      <div className="flex h-[160px] animate-pulse rounded-2xl bg-white/5" />
    </div>
  );
}
    ...
    <main className="min-h-screen bg-black text-white">
      <section className="mx-auto max-w-6xl px-6 py-10">
        ...
        <section className="mb-10">
          ...
          <Suspense fallback={<MascotasSkeleton />}>
            <MascotasContent />
          </Suspense>
        </section>
